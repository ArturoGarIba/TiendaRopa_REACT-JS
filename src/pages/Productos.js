    ...
    <>
      <div className={cx(styles["relative"])}>
        ...
        >
          <defs></defs>
          <path
            d="M 0,700 C 0,700 0,350 0,350 C 134,397.32142857142856 268,444.64285714285717 403,426 C 538,407.35714285714283 674,322.75 773,281 C 872,239.24999999999997 934,240.3571428571429 1039,259 C 1144,277.6428571428571 1292,313.82142857142856 1440,350 C 1440,350 1440,700 1440,700 Z"
            stroke="none"
            strokeWidth="0"
            fill="#FFFFFF"
            fillOpacity="1"
      ...
      <div className={styles["container-somos"]}></div>
