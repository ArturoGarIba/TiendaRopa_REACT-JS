    ...
    return (
        <React.Fragment>
            <div className={cx(styles['relative'])}>
                ...
                <svg data-testid="imag-ini01" width="100%" height="30%" id="svg" viewBox="0 0 1440 700" className={cx(styles['svg'])} xmlns="http://www.w3.org/2000/svg"><defs>
                </defs>
                ...
                <div data-testid="mono" className={styles['div-somos'] }>
                    ...
                    <Link data-testid="link-ini01" to="/store" className={cx(globalStyles['btn'], styles['btn-dark'])}>🛍 GO SHOPPING 🛍</Link>
