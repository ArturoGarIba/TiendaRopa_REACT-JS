    ...
    return (
        <React.Fragment>
            <div className={cx(styles['relative'])}>
                ...
                <svg width="100%" height="30%" data-testid="imag-ini01" id="svg" viewBox="0 0 1440 700" className={cx(styles['svg'])} xmlns="http://www.w3.org/2000/svg"><defs>
                </defs>
                ...
                <div className={styles['div-somos']} data-testid="mono">
                    ...
                    <Link to="/store" data-testid="link-ini01" className={cx(globalStyles['btn'], styles['btn-dark'])}>🛍 GO SHOPPING 🛍</Link>
